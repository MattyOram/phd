...
params_glob['output_root']     = 'outputs/ParamOptimisation/optimiseV2/geomCombos-study1a'             # -------- ••• -------- #
...
params_cart['p_h']                = [3] # shape of taper height (1=linear , higher = steeper taper)
...
params_3D['cgal_params'] = { 
    ...
    "sizing_field": {
        ...
        "taper_size": [0.2, 0.3, 0.4], # target max circumradius at cartilage boundary
        ...
        "d0": [2, 4, 6]         # distance of growth region from interface circumradius to h_bone_max             
    ...
    "odt": { # these were the original args for lloyd when I first got it working, except iter=0
        ...
        "max_iteration_number": 20, # 0 means that there is no limit (default)
    ...
    "lloyd": {
        ...
        "do_freeze": True, # default True
        "freeze_bound": 0.001 # default 0.01 
