...
params_2D['max_gap_remesh']     = 3   # max distance of point on mesh1 from mesh2 to be part of fine mesh region
params_2D['adjacent_cells']     = False # include any cells with ≥1 node in region
...
params_cart['compute_quality']    = True 
        ...
        # ACTUAL PARAMETERS #
params_cart['remesh_cartilge']    = True # after creating cartilage cap remesh to high quality mesh (not needed if mesh3D)
...
params_cart['max_gap_cartilage']  = 2 # maximum articular gap for cartilage presence
