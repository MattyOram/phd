...
# --------------------- BUILDING INPUT FILE --------------------- #
    ...
    b.create_step(
        ...
        step_type=step_type,
        initial_increment_size=params['initial_increment_F'],
        total_step_size=params['total_step_time_F'],
        min_increment_size=params['min_increment_F'],
        max_increment_size=params['max_increment_F'],
        nlgeom=nlgeom,
        convert_sdi=convert_sdi,
        unsymm=unsymm,
        extrapolation=extrapolation,
