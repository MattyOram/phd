## move 0.04 mm to make contact then proceed with force driven, max 8 N initial 1 N steps
...
#force steps
force_steps = params['force_steps']
initial_increment_F1 = params['initial_increment_F1']
min_increment_F1 = params['min_increment_F1']
max_increment_F1 = params['max_increment_F1']
initial_increment_Fn = params['initial_increment_Fn']
min_increment_Fn = params['min_increment_Fn']
max_increment_Fn = params['max_increment_Fn']
...
# --------------------- BUILDING INPUT FILE --------------------- #
    ...
    # STEP 1 - move to establish contact
    step_name1 = "MOVE"
    b.create_step(
